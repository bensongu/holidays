...
module Holidays
  ...
  module CA # :nodoc:
    def self.defined_regions
      [:ca, :ca_qc, :ca_nf, :ca_nt, :ca_nu, :ca_ab, :ca_on, :ca_sk, :ca_mb, :ca_bc, :ca_ns, :ca_yk, :ca_nb, :ca_pe, :us]
    end
    ...
    def self.holidays_by_month
      ...
      11 => [{:mday => 11, :name => "Remembrance Day", :regions => [:ca_bc, :ca_ab, :ca_sk, :ca_nb, :ca_pe, :ca_yk, :ca_nt, :ca_nu]}],
